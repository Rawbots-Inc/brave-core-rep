...
public class PopupWindowTooltipCustom implements PopupWindow.OnDismissListener {
    private static final String TAG = PopupWindowTooltipCustom.class.getSimpleName();
    ...
    private PopupWindowTooltipCustom(Builder builder) {
    ...
    private void configContentView() {
        ...
        contentViewParams.setMargins(0, (int) mArrowHeight, 0, 0);
    ...
    private final ViewTreeObserver.OnGlobalLayoutListener mShowLayoutListener =
            new ViewTreeObserver.OnGlobalLayoutListener() {
                ...
                public void onGlobalLayout() {
                    ...
                    if (popup == null || dismissed) return;
                    popup.getContentView().getViewTreeObserver().removeOnGlobalLayoutListener(this);
                    if (mOnShowListener != null) mOnShowListener.onShow(PopupWindowTooltipCustom.this);
    ...
    public interface OnDismissListener {
        void onDismiss(PopupWindowTooltipCustom tooltip);
    }
    public interface OnShowListener {
        void onShow(PopupWindowTooltipCustom tooltip);
    }
    ...
    public static class Builder {
        ...
        public PopupWindowTooltipCustom build() throws IllegalArgumentException {
            validateArguments();
            if (arrowColor == 0) {
            ...
            return new PopupWindowTooltipCustom(this);
        }
