...
inline constexpr char kAdPrivacyLearnMoreURL[] = "https://thefreedombrowser.com/";
...
inline constexpr char kAutomaticSettingsResetLearnMoreURL[] =
    "https://thefreedombrowser.com/hc/en-us/articles/"
...
inline constexpr char16_t kBatterySaverModeLearnMoreUrl[] =
    u"https://thefreedombrowser.com/hc/en-us/articles/"
...
inline constexpr char16_t kChromeFixUpdateProblems[] =
    u"https://thefreedombrowser.com/";

// General help links for Chrome, opened using various actions.
inline constexpr char kChromeHelpViaKeyboardURL[] =
    "https://thefreedombrowser.com/";
inline constexpr char kChromeHelpViaMenuURL[] = "https://thefreedombrowser.com/";

inline constexpr char kChromeHelpViaWebUIURL[] = "https://thefreedombrowser.com/";
...
inline constexpr char16_t kChromeSafePageURL[] = u"https://thefreedombrowser.com/";
...
inline constexpr char16_t kFamilyGroupViewURL[] = u"https://thefreedombrowser.com/";
...
inline constexpr char kGoogleAccountURL[] = "https://thefreedombrowser.com/";

// URL of the Google Account chooser.
inline constexpr char kGoogleAccountChooserURL[] = "https://thefreedombrowser.com/";
...
inline constexpr char kGooglePasswordManagerURL[] = "https://thefreedombrowser.com";

// The URL for the "Learn more" link for the High Efficiency Mode.
inline constexpr char16_t kMemorySaverModeLearnMoreUrl[] =
    u"https://thefreedombrowser.com/hc/en-us/articles/13383683902733";
...
inline constexpr char kManage3pcHelpCenterURL[] = "https://thefreedombrowser.com/";

// The URL for the tab group sync help center page.
inline constexpr char kTabGroupsLearnMoreURL[] = "https://thefreedombrowser.com/";

// The URL for the Learn More page about policies and enterprise enrollment.
inline constexpr char16_t kManagedUiLearnMoreUrl[] =
    u"https://thefreedombrowser.com/hc/en-us/articles/360039248271-Group-Policy";
...
inline constexpr char16_t kPaymentMethodsURL[] = u"https://thefreedombrowser.com";
...
inline constexpr char16_t kWalletUrl[] = u"https://thefreedombrowser.com";
...
inline constexpr char kSafetyTipHelpCenterURL[] =
    "https://thefreedombrowser.com/hc/en-us/articles/17550072876045-Lookalike-URLs";
...
// password.
inline constexpr char kSeeMoreSecurityTipsURL[] = "https://thefreedombrowser.com/";
...
inline constexpr char kSyncErrorsHelpURL[] = "https://thefreedombrowser.com/";
...
inline constexpr char kSyncGoogleDashboardURL[] = "https://thefreedombrowser.com/";

// The URL for the "Learn more" page for sync setup on the personal stuff page.
inline constexpr char16_t kSyncLearnMoreURL[] = u"https://thefreedombrowser.com/";
...
inline constexpr char kComposeLearnMorePageURL[] = "https://thefreedombrowser.com/";
...
inline constexpr char kWalletPassesPageURL[] = "https://thefreedombrowser.com/";
...
inline constexpr char kPrivacyPolicyURL[] = "https://thefreedombrowser.com/";

// The URL path to Google's Privacy Policy page for users in China.
inline constexpr char kPrivacyPolicyURLChina[] = "https://thefreedombrowser.com/";
...
inline constexpr char kWindows78DeprecationURL[] =
    "https://thefreedombrowser.com/hc/en-us/articles/11197967945613";
#endif  // BUILDFLAG(IS_WIN)

// "Learn more" URL for the one click signin infobar.
inline constexpr char kChromeSyncLearnMoreURL[] = "https://thefreedombrowser.com/";
