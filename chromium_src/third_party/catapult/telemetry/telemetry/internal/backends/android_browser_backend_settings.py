...
ANDROID_BRAVE = GenericChromeBackendSettings(browser_type='android-brave',
                                             package='com.rawbots.repsky_browser')

ANDROID_BRAVE_DEFAULT = GenericChromeBackendSettings(
    browser_type='android-brave-default', package='com.rawbots.repsky_browser_default')

ANDROID_BRAVE_BETA = GenericChromeBackendSettings(
    browser_type='android-brave-beta', package='com.rawbots.repsky_browser_beta')

ANDROID_BRAVE_DEV = GenericChromeBackendSettings(
    browser_type='android-brave-dev', package='com.rawbots.repsky_browser_dev')

ANDROID_BRAVE_NIGHTLY = GenericChromeBackendSettings(
    browser_type='android-brave-nightly', package='com.rawbots.repsky_browser_nightly')
